...
namespace TEditor
{
    ...
    public sealed class TEditorViewController : UIViewController
    {
        ...
        {
            string htmlResource = _richTextEditor.LoadResourcesIOS();
        ...
        public override void ViewDidLoad()
        {
            ...
            NavigationController.NavigationBar.BarTintColor = UIColor.FromRGB(0, 187, 255);
        }
        ...
        void KeyboardWillShowOrHide(NSNotification notification)
        {
            ...
            if (notification.Name == UIKeyboard.WillShowNotification)
            {
                UIView.Animate(duration, 0, animationOptions, () =>
                {
                    ...
                    _richTextEditor.SetContentHeight(editorFrame.Height);
                }, null);
            }
            else
            {
